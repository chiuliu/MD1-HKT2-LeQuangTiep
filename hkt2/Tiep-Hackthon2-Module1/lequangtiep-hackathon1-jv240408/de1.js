function renderLanguages() {
  ...
  const languageRow1 = document.createElement("div");
  languageRow1.classList.add("d-flex", "flex-wrap", "justify-content-center", "mt-4", "mt-md-5");
  const languageRow2 = document.createElement("div");
  languageRow2.classList.add("d-flex", "flex-wrap", "justify-content-center", "mt-4", "mt-md-5");

  for (let i = 0; i < languages.length; i++) {
    const language = languages[i];

    const languageCard = document.createElement("div");
    languageCard.classList.add("mx-3", "ms-sm-0", "mb-3", "card-bg", "rounded", "p-1", "pe-3", "p-md-3", "pe-md-4", "shadow-sm");
    languageCard.innerHTML = `
      <div class="d-flex align-items-center">
        <div class="thumb-md d-flex flex-wrap justify-content-center align-items-center">
          <img src="${language.img}" alt="" class="" height="34" />
        </div>
        <div class="ms-3">
    ...
    `;
    if (i < 5) {
      languageRow1.appendChild(languageCard);
    } else {
      languageRow2.appendChild(languageCard);
    }
  }
  languageElement.appendChild(languageRow1);
  languageElement.appendChild(languageRow2);
}
renderLanguages();
